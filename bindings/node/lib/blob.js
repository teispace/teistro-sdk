...
export function decodePanchanga(bytes) {
  ...
  }
  {
    ...
    out.days = {
      ...
      monthKind: column(blob, at, 6, 'u8', at.count),
      ayana: column(blob, at, 7, 'u16', at.count),
      dishaShool: column(blob, at, 8, 'u16', at.count),
      hasSankranti: column(blob, at, 9, 'u8', at.count),
      sankranti: column(blob, at, 10, 'f64', at.count),
      hasAbhijit: column(blob, at, 11, 'u8', at.count),
      abhijitFrom: column(blob, at, 12, 'f64', at.count),
      abhijitTo: column(blob, at, 13, 'f64', at.count),
      abhijitEffective: column(blob, at, 14, 'u8', at.count),
      hasBrahma: column(blob, at, 15, 'u8', at.count),
      brahmaFrom: column(blob, at, 16, 'f64', at.count),
      brahmaTo: column(blob, at, 17, 'f64', at.count),
      moonWindowFrom: column(blob, at, 18, 'f64', at.count),
      moonWindowTo: column(blob, at, 19, 'f64', at.count),
      length: at.count,
    };
  }
  {
