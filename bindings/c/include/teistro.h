 ...
 * (crates/core/src/error.rs, crates/port-ephemeris/src/body.rs, crates/port-ephemeris/src/capabilities.rs, crates/port-ephemeris/src/frame.rs, crates/port-ephemeris/src/vtable.rs, crates/ffi/src/lib.rs, crates/ffi/src/strings.rs, crates/ffi/src/blob.rs, crates/ffi/src/context.rs, crates/ffi/src/keys.rs, crates/ffi/src/frame.rs, crates/ffi/src/calendar.rs, crates/ffi/src/chart.rs, crates/ffi/src/time.rs, crates/ffi/src/intl.rs, crates/ffi/src/positions.rs, crates/ffi/src/panchanga.rs, crates/ffi/src/ephemeris.rs, crates/ffi/src/provider.rs); do not edit. ABI version 1, SDK 0.0.0.
 ...
 */
typedef enum ts_provider_code {
    /**
     * The call succeeded.
     */
    TS_PROVIDER_CODE_OK = 0,
    /**
 ...
 * §8).
 */
typedef enum ts_sunrise {
    /**
     * The centre of the disc on the geometric horizon.
     */
    TS_SUNRISE_CENTRE_NO_REFRACTION = 0,
    /**
     * The upper limb with refraction.
     */
    TS_SUNRISE_UPPER_LIMB_REFRACTION = 1,
    /**
 ...
 */
typedef enum ts_lunar_month {
    /**
     * New moon to new moon.
     */
    TS_LUNAR_MONTH_AMANTA = 0,
    /**
     * Full moon to full moon.
     */
    TS_LUNAR_MONTH_PURNIMANTA = 1,
} ts_lunar_month;
 ...
 */
typedef enum ts_moon_event {
    /**
     * The Moon crossed the horizon upward.
     */
    TS_MOON_EVENT_RISE = 0,
    /**
 ...
 */
typedef struct ts_provider ts_provider;
...
typedef struct ts_panchanga_request ts_panchanga_request;
 ...
 * The blob follows the `panchanga` schema of idl/api.json.
 * Safety: `context` must be a live handle; `request` valid for a read; `out_blob`
 * valid for a write.
 */
 ...
 * Safety: `context` must be a live handle; `function` and `arguments_json` must
 ...
 * Safety: `provider` must be a live handle from `ts_provider_load`; every
 ...
 * matter.
 * Safety: `provider` must be null or a handle from `ts_provider_load` that is
 * not used again.
 */
