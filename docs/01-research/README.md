...
| [`competitive-analysis/`](competitive-analysis/00-matrix.md) | what do the products the baseline engine set out to replace, and the wider field, actually offer; and what does a *developer* choose between, which is a different tier and the one the SDK enters | web research on 2026-09-04 for the products (Jagannatha Hora, Parashara's Light, Kala, Shri Jyoti Star, Sky Vision, Astro-Vision, Maitreya, Solar Fire, Delphic Oracle, PyJHora, VedAstro, jyotishganit); extended 2026-09-10 to the libraries, engines and hosted APIs, with registry and repository figures measured rather than quoted ([`02-developer-market.md`](competitive-analysis/02-developer-market.md)) |
