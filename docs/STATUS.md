...
**Last updated:** 2026-09-21 (a fifth composer, `positions`, and the last
...
and no warning; the five now write 10 581 items and 21 162 clean
renderings. Next: **a decision, not a task** — the messages the remaining
composers need, and the interpretation records, which the corpus does not
hold); before that
