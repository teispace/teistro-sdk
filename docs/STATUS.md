...
2b. **Tajika, after the office-bearers** (`03-design/muntha.md`, "The
   ...
   **the caller has founded**, and reproduce the source's worked year end
   ...
   year. Left: the **crossing** of the strengths and the year lord; then
   the **Tajika aspects** with their deeptamsha orbs, which are a
   different thing from the sign aspect the year lord uses and are what
   the sixteen yogas, the sahamas and the Ithasala family need. Then the year lord
