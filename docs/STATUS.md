...
**Last updated:** 2026-09-21 (a third composer, `strength`, and the first
over a section: each graha's Shadbala in rupas, strongest first, adding no
message because both strict locales already carried one nobody used, and
saying nothing of whether a graha is strong enough because no locale can —
...
and no warning. Next: the six remaining composers, and a decision on the
interpretation records, which the corpus does not hold); before that
