...
2b. **Tajika, after the office-bearers** (`03-design/muntha.md`, "The
   ...
   *Bhavishyat* are corrected, the missing `Poorna` is built, and the
   ...
   it. Left: the **fourteen other yogas** — Kamboola, Nakta, Yamaya,
   Manau, Khallasara, Rudda and the rest — which are compositions over
   those pairs and now **designed** (`03-design/tajika-yogas.md`), and
   which take a **matter** as well as a chart, because fourteen of the
   sixteen are judgements about a lagnesha and a karyesha; the **36
   sahamas**; the year lord's two Moon readings that turn on the
   Ithasala; and the four dashas the annual chart unblocks.
