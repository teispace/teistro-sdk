...
1. Phase 2's astronomy as above (it is "Now"): a chart founded on a
   ...
   (`'SURYA_SIDDHANTA'`), which the parity gate compares. Left of this
   item: whether a classical chart earns a profile of its own
   (`classical-chart.md` §8). The settable atmosphere for the rise and set solver
