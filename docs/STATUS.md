...
- Phase 1's remaining deliverables, in the roadmap's order: the `intl`
  ...
  then the
  test-only infrastructure, the conformance repository (ADR-0022), the
  docs site. The cross-architecture hash matrix is built (thirty-fifth
