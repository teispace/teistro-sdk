...
**Last updated:** 2026-09-21 (a fourth composer, `houses`, and the first to
...
and no warning; the four now write 9744 items and 19 488 clean renderings.
Next: the remaining composers — the next of which is the first that needs a
new translated key, which is a translator's decision and not a composer's —
and a decision on the interpretation records, which the corpus does not
hold); before that
