...
warning, in English and Nepali. Next: the façade's `plan`, then the
readings composer); before that 2026-09-20 (a rule renders to prose: `teistro_rules::prose`
