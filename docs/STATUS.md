...
2b. **Tajika, after the office-bearers** (`03-design/muntha.md`, "The
   ...
   **the caller has founded**, and reproduce the source's worked year end
   ...
   those pairs; the **36 sahamas**; the year lord's two Moon readings that
   turn on the Ithasala; and the four dashas the annual chart unblocks. Then the year lord
