...
**Last updated:** 2026-09-23 (**the sixteen Tajika yogas cross to all
...
2b. **Tajika, after the office-bearers** (`03-design/muntha.md`, "The
   ...
   *Bhavishyat* are corrected, the missing `Poorna` is built, and the
   ...
   and their legs, and `unanswered` as a bit set. Left: Kuttha
   (`03-design/tajika-yogas.md`); the **36 sahamas**; the year
