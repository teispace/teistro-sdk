...
**Last updated:** 2026-09-23 (**a refusal names the value that failed**:
...
2b. **Tajika, after the office-bearers** (`03-design/muntha.md`, "The
   ...
   *Bhavishyat* are corrected, the missing `Poorna` is built, and the
   ...
   `varsha_json.sahams` and `sahamRules`. Left: Kuttha
   (`03-design/tajika-yogas.md`); the sahams' strength, which waits on
   the **Harsha bala**, crossing with the birth chart's sahams; the year
