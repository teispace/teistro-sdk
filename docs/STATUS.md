...
2b. **Tajika, after the office-bearers** (`03-design/muntha.md`, "The
   ...
   **the caller has founded**, and reproduce the source's worked year end
   ...
   that chose it and every claim it was chosen over. Left: the **Tajika
   aspects** with their deeptamsha orbs, which are a different thing from
   the sign aspect the year lord uses and are what the sixteen yogas, the
   36 sahamas and the Ithasala family need; then those yogas. Then the year lord
