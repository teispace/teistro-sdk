...
**Last updated:** 2026-09-09, end of the sixty-first session (the parity
...
2. The local checkout is the repository root; `cargo xtask check-docs`
   ...
   2026-09-05).
3. **The next task is the Indian lunisolar calendar's adhika and kshaya
   months**, which `panchanga` still needs — the one piece of the daily
   almanac that is not yet computed from first principles.
