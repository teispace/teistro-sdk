...
1. Phase 2's astronomy as above (it is "Now"): the classical provider's
   Lagna and planetary hours exposed through the chart layer when it
   exists. The settable atmosphere for the rise and set solver (C34) is
   built (`03-design/horizon-atmosphere.md`); the dip of a raised horizon
   waits for a consumer who asks.
