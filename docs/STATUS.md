...
2b. **Tajika, after the office-bearers** (`03-design/muntha.md`, "The
   ...
   **the caller has founded**, and reproduce the source's worked year end
   ...
   mean of a pair, Ithasala and Ishrafa, and the pairs that make one
   cross. Left: the **fourteen other yogas** — Kamboola, Nakta, Yamaya,
   Manau, Khallasara, Radda and the rest — which are compositions over
   those pairs and now **designed** (`03-design/tajika-yogas.md`), which
   begins with two corrections to what shipped (C110, C111) and the
   missing Poorna; the **36 sahamas**; the year lord's two Moon readings
   that turn on the Ithasala; and the four dashas the annual chart
   unblocks. Then the year lord
   (C106), then the four dashas the annual chart unblocks.
