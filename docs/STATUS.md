...
**Last updated:** 2026-09-23 (**the Tajika sahams are built**, all
...
2b. **Tajika, after the office-bearers** (`03-design/muntha.md`, "The
   ...
   *Bhavishyat* are corrected, the missing `Poorna` is built, and the
   ...
   `muntha-measured.md` §14. Left: Kuttha
   (`03-design/tajika-yogas.md`); the sahams **across the boundary**,
   then their strength, which waits on the **Harsha bala**; the year
