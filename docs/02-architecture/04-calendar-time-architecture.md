...
Status: `draft`, 2026-09-04. Depends on Q9.
...
doubled-day flags for lunisolar systems), era and a `source` flag
(`official-table`, `computed`) so a BS date says which it was.
