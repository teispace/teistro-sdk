...
The description carries 2 exported constants, 97 enums of 969 members in
...
|---|---|---|---|---|---|
| Dart | 1332 | 1 | 0 | 0 | 0 |
| TypeScript | 363 | 0 | 0 | 1 | 0 |
| Python | 1332 | 0 | 1 | 2 | 0 |

| proposed rule | verdict | measured |
|---|---|---|
| no identifier the Dart emitter writes is a reserved word there | **holds** | 1 caught and renamed, 0 left; 1332 looked at |
| no identifier the TypeScript emitter writes is a reserved word there | **holds** | 1 caught and renamed, 0 left; 363 looked at |
| no identifier the Python emitter writes is a reserved word there | **holds** | 3 caught and renamed, 0 left; 1332 looked at |
| renaming leaves no two names alike in one scope in Dart | **holds** | 0 of 1332 disagree |
| renaming leaves no two names alike in one scope in TypeScript | **holds** | 0 of 363 disagree |
| renaming leaves no two names alike in one scope in Python | **holds** | 0 of 1332 disagree |
...
|---|---|---|---|---|
| `u8` | `c_uint8` | `B` | 67 | 66 |
| `u16` | `c_uint16` | `H` | 20 | 68 |
| `u32` | `c_uint32` | `I` | 49 | 32 |
| `u64` | `c_uint64` | `Q` | 1 | 0 |
| `i8` | `c_int8` | `b` | 0 | 0 |
| `i16` | `c_int16` | `h` | 0 | 0 |
| `i32` | `c_int32` | `i` | 17 | 5 |
...
| every blob column's scalar has a format code | **holds** | 0 of 283 disagree |
...
much of that there is to reach for: 192 of 192 visible struct fields
carry a doc comment.
...
| proposed rule | verdict | measured |
|---|---|---|
| every visible field carries a doc comment | **holds** | 0 of 192 disagree |
| every floating-point field carries a unit | **holds** | 0 of 192 disagree |
