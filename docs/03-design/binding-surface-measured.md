...
The description carries 2 exported constants, 106 enums of 1029 members
...
| proposed rule | verdict | measured |
|---|---|---|
| no identifier the Dart emitter writes is a reserved word there | **holds** | 1 caught and renamed, 0 left; 1397 looked at |
| no identifier the TypeScript emitter writes is a reserved word there | **holds** | 1 caught and renamed, 0 left; 368 looked at |
| no identifier the Python emitter writes is a reserved word there | **holds** | 3 caught and renamed, 0 left; 1397 looked at |
| renaming leaves no two names alike in one scope in Dart | **holds** | 0 of 1397 disagree |
| renaming leaves no two names alike in one scope in TypeScript | **holds** | 0 of 368 disagree |
| renaming leaves no two names alike in one scope in Python | **holds** | 0 of 1397 disagree |
...
| every blob column's scalar has a format code | **holds** | 0 of 392 disagree |
