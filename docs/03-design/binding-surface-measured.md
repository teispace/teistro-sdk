...
The description carries 2 exported constants, 120 enums of 1141 members
...
|---|---|---|---|---|---|
| Dart | 1512 | 1 | 0 | 0 | 0 |
| TypeScript | 371 | 0 | 0 | 1 | 0 |
| Python | 1512 | 0 | 1 | 2 | 0 |

| proposed rule | verdict | measured |
|---|---|---|
| no identifier the Dart emitter writes is a reserved word there | **holds** | 1 caught and renamed, 0 left; 1512 looked at |
| no identifier the TypeScript emitter writes is a reserved word there | **holds** | 1 caught and renamed, 0 left; 371 looked at |
| no identifier the Python emitter writes is a reserved word there | **holds** | 3 caught and renamed, 0 left; 1512 looked at |
| renaming leaves no two names alike in one scope in Dart | **holds** | 0 of 1512 disagree |
| renaming leaves no two names alike in one scope in TypeScript | **holds** | 0 of 371 disagree |
| renaming leaves no two names alike in one scope in Python | **holds** | 0 of 1512 disagree |

What Dart renames:

- ChartKind: `return` → `returnValue`

What TypeScript renames:

- ts_ephemeris_call: `function` → `function_`
...
| `ts_chart_request` | 152 | 8 | 104 | yes |
...
| every blob column's scalar has a format code | **holds** | 0 of 520 disagree |
...
much of that there is to reach for: 200 of 200 visible struct fields
carry a doc comment.
...
| proposed rule | verdict | measured |
|---|---|---|
| every visible field carries a doc comment | **holds** | 0 of 200 disagree |
| every floating-point field carries a unit | **holds** | 0 of 200 disagree |
