...
The description carries 2 exported constants, 108 enums of 1050 members
...
| proposed rule | verdict | measured |
|---|---|---|
| no identifier the Dart emitter writes is a reserved word there | **holds** | 1 caught and renamed, 0 left; 1418 looked at |
| no identifier the TypeScript emitter writes is a reserved word there | **holds** | 1 caught and renamed, 0 left; 368 looked at |
| no identifier the Python emitter writes is a reserved word there | **holds** | 3 caught and renamed, 0 left; 1418 looked at |
| renaming leaves no two names alike in one scope in Dart | **holds** | 0 of 1418 disagree |
| renaming leaves no two names alike in one scope in TypeScript | **holds** | 0 of 368 disagree |
| renaming leaves no two names alike in one scope in Python | **holds** | 0 of 1418 disagree |
...
|---|---|---|---|---|
| `u8` | `c_uint8` | `B` | 67 | 110 |
| `u16` | `c_uint16` | `H` | 20 | 109 |
| `u32` | `c_uint32` | `I` | 49 | 36 |
| `u64` | `c_uint64` | `Q` | 1 | 0 |
| `i8` | `c_int8` | `b` | 0 | 0 |
| `i16` | `c_int16` | `h` | 0 | 0 |
| `i32` | `c_int32` | `i` | 17 | 7 |
...
| every blob column's scalar has a format code | **holds** | 0 of 426 disagree |
