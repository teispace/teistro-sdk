...
The description carries 2 exported constants, 115 enums of 1127 members
...
| proposed rule | verdict | measured |
|---|---|---|
| no identifier the Dart emitter writes is a reserved word there | **holds** | 1 caught and renamed, 0 left; 1497 looked at |
| no identifier the TypeScript emitter writes is a reserved word there | **holds** | 1 caught and renamed, 0 left; 370 looked at |
| no identifier the Python emitter writes is a reserved word there | **holds** | 3 caught and renamed, 0 left; 1497 looked at |
| renaming leaves no two names alike in one scope in Dart | **holds** | 0 of 1497 disagree |
| renaming leaves no two names alike in one scope in TypeScript | **holds** | 0 of 370 disagree |
| renaming leaves no two names alike in one scope in Python | **holds** | 0 of 1497 disagree |
