...
The description carries 2 exported constants, 100 enums of 975 members
...
| proposed rule | verdict | measured |
|---|---|---|
| no identifier the Dart emitter writes is a reserved word there | **holds** | 1 caught and renamed, 0 left; 1338 looked at |
| no identifier the TypeScript emitter writes is a reserved word there | **holds** | 1 caught and renamed, 0 left; 363 looked at |
| no identifier the Python emitter writes is a reserved word there | **holds** | 3 caught and renamed, 0 left; 1338 looked at |
| renaming leaves no two names alike in one scope in Dart | **holds** | 0 of 1338 disagree |
| renaming leaves no two names alike in one scope in TypeScript | **holds** | 0 of 363 disagree |
| renaming leaves no two names alike in one scope in Python | **holds** | 0 of 1338 disagree |
...
| every blob column's scalar has a format code | **holds** | 0 of 329 disagree |
