...
| **not built** | the fourteen yogas above Ithasala and Ishrafa, now designed in [`tajika-yogas.md`](tajika-yogas.md); the sahams, built since in [`tajika-sahams.md`](tajika-sahams.md), which need no aspect until their strength is read. The two corrections Table X-3 found — C110's degree on Ishrafa and C111's *Bhavishyat* — **are built**, together with the `Poorna` kind that was missing |
