...
| every type an area's signature names is reachable from the crate root | falsified | 12 of 94 disagree; not reachable: `Chain`, `Content`, `DashaName`, `DashaSystems`, `Evaluator`, `JaiminiReading`, `Labels`, `Readings`, `Rule`, `Running`, `Theme`, `VargaSigns` |
