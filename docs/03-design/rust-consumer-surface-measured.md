...
| every type an area's signature names is reachable from the crate root | falsified | 12 of 56 disagree; not reachable: `Chain`, `Content`, `DashaName`, `DashaSystems`, `Evaluator`, `Labels`, `LifeClass`, `Readings`, `Running`, `Theme`, `UduDefinition`, `VargaSigns` |
