...
| every type an area's signature names is reachable from the crate root | falsified | 11 of 62 disagree; not reachable: `Chain`, `Content`, `DashaName`, `DashaSystems`, `Evaluator`, `Labels`, `Readings`, `Rule`, `Running`, `Theme`, `VargaSigns` |
