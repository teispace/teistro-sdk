...
**A context and its areas need 10 of the SDK's crates**: `teistro-aspect`, `teistro-astro`, `teistro-calendar`, `teistro-chart`, `teistro-core`, `teistro-intl`, `teistro-panchanga`, `teistro-port-ephemeris`, `teistro-serial`, `teistro-time`.

## The properties

| proposed rule | verdict | measured |
|---|---|---|
| an area's operations come from one SDK crate, so a Rust consumer already has the area | falsified | 7 of 8 disagree; more than one: `almanac (8)`, `calendar (2)`, `chart (8)`, `engine (2)`, `frame (2)`, `intl (3)`, `time (4)` |
...
| the façade owns the composition: every crate a context needs is one it depends on | **holds** | 0 of 10 disagree; so every area's composition has a home outside the C boundary |
...
| `almanac` | 8 | `teistro-aspect`, `teistro-astro`, `teistro-calendar`, `teistro-chart`, `teistro-core`, `teistro-panchanga`, `teistro-port-ephemeris`, `teistro-time` |
| `calendar` | 2 | `teistro-calendar`, `teistro-core` |
| `chart` | 8 | `teistro-aspect`, `teistro-astro`, `teistro-calendar`, `teistro-chart`, `teistro-core`, `teistro-port-ephemeris`, `teistro-serial`, `teistro-time` |
...
|---|---|---|---|
| `ts_chart_found` | `chart` | 8 | `teistro-aspect`, `teistro-astro`, `teistro-calendar`, `teistro-chart`, `teistro-core`, `teistro-port-ephemeris`, `teistro-serial`, `teistro-time` |
| `ts_panchanga_days` | `panchanga` | 8 | `teistro-aspect`, `teistro-astro`, `teistro-calendar`, `teistro-chart`, `teistro-core`, `teistro-panchanga`, `teistro-port-ephemeris`, `teistro-time` |
