...
**A context and its areas need 9 of the SDK's crates**: `teistro-astro`, `teistro-calendar`, `teistro-chart`, `teistro-core`, `teistro-intl`, `teistro-panchanga`, `teistro-port-ephemeris`, `teistro-serial`, `teistro-time`.

## The properties

| proposed rule | verdict | measured |
|---|---|---|
| an area's operations come from one SDK crate, so a Rust consumer already has the area | falsified | 7 of 8 disagree; more than one: `almanac (7)`, `calendar (2)`, `chart (7)`, `engine (2)`, `frame (2)`, `intl (3)`, `time (4)` |
...
| `chart` | 7 | `teistro-astro`, `teistro-calendar`, `teistro-chart`, `teistro-core`, `teistro-port-ephemeris`, `teistro-serial`, `teistro-time` |
...
|---|---|---|---|
| `ts_chart_found` | `chart` | 7 | `teistro-astro`, `teistro-calendar`, `teistro-chart`, `teistro-core`, `teistro-port-ephemeris`, `teistro-serial`, `teistro-time` |
