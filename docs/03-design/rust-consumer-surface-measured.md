...
| every type an area's signature names is reachable from the crate root | falsified | 12 of 74 disagree; not reachable: `Chain`, `Content`, `DashaName`, `DashaSystems`, `Evaluator`, `Labels`, `Readings`, `Rule`, `Running`, `Strength`, `Theme`, `VargaSigns` |
