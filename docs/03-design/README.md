...
| `serial.md` (the extended envelope; the foundation: `chart-foundation.md`; vargas: `varga-kernel.md`; the state: `state-and-avasthas.md`; the drishti: `aspect-and-drishti.md`; the points: `derived-points.md`; the houses: `houses-service.md`) | 4 |
