...
| `houses.md` (the foundation: `chart-foundation.md`; vargas: `varga-kernel.md`; the state: `state-and-avasthas.md`; the drishti: `aspect-and-drishti.md`; the points: `derived-points.md`) | 4 |
