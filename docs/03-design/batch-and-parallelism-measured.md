...
| almanac | 1 | 841 | 1069 | 952 | 2 | 1.27 | 841.0 |
| almanac | 2 | 1665 | 2119 | 1723 | 2 | 1.27 | 832.5 |
| almanac | 10 | 8453 | 10 800 | 8239 | 2 | 1.28 | 845.3 |
| almanac | 50 | 41 492 | 52 714 | 39 675 | 2 | 1.27 | 829.8 |
...
range of 50 almanac days is 41 492, or 830 a day. Neither is a batch
...
1.10 for charts and 1.27 for an almanac: the SDK asks its ephemeris for
...
before it, so there is no grid to ask for. A day's 830 calls are **not**
...
| a batch of almanac is one call whatever its size | falsified | 41 492 calls for 50, 830 per item |
| the calls a batch makes are grids rather than cells | falsified | a chart's calls are 1.10 cells wide on average and an almanac day's 1.27; the widest either makes is 8 and 2 |
