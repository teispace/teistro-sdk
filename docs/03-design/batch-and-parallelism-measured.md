...
| almanac | 1 | 665 | 1069 | 952 | 66 | 1.61 | 665.0 |
| almanac | 2 | 1313 | 2119 | 1723 | 66 | 1.61 | 656.5 |
| almanac | 10 | 6693 | 10 800 | 8239 | 66 | 1.61 | 669.3 |
| almanac | 50 | 32 692 | 52 714 | 39 675 | 66 | 1.61 | 653.8 |
...
range of 50 almanac days is 32 692, or 654 a day. Neither is a batch
...
1.10 for charts and 1.61 for an almanac: the SDK asks its ephemeris for
...
before it, so there is no grid to ask for. A day's 654 calls are **not**
...
| a batch of almanac is one call whatever its size | falsified | 32 692 calls for 50, 654 per item |
| the calls a batch makes are grids rather than cells | falsified | a chart's calls are 1.10 cells wide on average and an almanac day's 1.61; the widest either makes is 8 and 66 |
| a batch asks for each cell once | falsified | 64.7% of a batch of 50 charts and 24.7% of 50 almanac days are cells already fetched |
