...
`report` writes sizes and coverage; `migrate baseline` imported the
baseline engine's name tables (the four launch languages' entity records,
2026-09-06); the runtime `load_pack`,
