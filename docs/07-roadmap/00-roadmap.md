...
| the panchanga day | **designed and measured**: `cargo xtask panchanga` falsifies a proposed rule for each of the recorded section's twenty-seven fields over all 55 days (`03-design/panchanga-day-conventions.md`, held by `check-panchanga`), and `03-design/panchanga-day.md` is written from it. The crate is next |
